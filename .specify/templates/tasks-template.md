...
- [ ] T004 [P] Define or update automated quality checks required for this feature
...
- [ ] T013 [P] [US1] UX/state validation for [flow] in [path or artifact]
...
- [ ] T022 [P] [US2] UX/state validation for [flow] in [path or artifact]
...
- [ ] T029 [P] [US3] UX/state validation for [flow] in [path or artifact]
...
- [ ] TXXX UX consistency review across affected flows
...
- UX/state validation tasks can run in parallel with non-conflicting implementation work
...
Task: "UX/state validation for [flow] in [path or artifact]"
...
- Record UX consistency checks for user-facing changes
